...
function showBlocks() {
  ...
  document.getElementById('lifeInputs').style.display        = (t === 'life') ? '' : 'none';
  document.getElementById('determinateInputs').style.display = (t === 'determinate') ? '' : 'none';
  document.getElementById('aggregateInputs').style.display   = (t === 'aggregate') ? '' : 'none';
  document.getElementById('suspendedInputs').style.display   = (t === 'suspended') ? '' : 'none';
}
document.getElementById('sentenceType').addEventListener('change', showBlocks);
showBlocks();
...
document.getElementById('testLifeBtn').addEventListener('click', (e) => {
  e.preventDefault();
  document.getElementById('sentenceType').value = 'life'; showBlocks();
...
document.getElementById('testDeterminateBtn').addEventListener('click', (e) => {
  e.preventDefault();
  document.getElementById('sentenceType').value = 'determinate'; showBlocks();
...
document.getElementById('testAggregateBtn').addEventListener('click', (e) => {
  e.preventDefault();
  document.getElementById('sentenceType').value = 'aggregate'; showBlocks();
  document.getElementById('dateOfSentence').value = '2020-01-01';
...
document.getElementById('testSuspendedBtn').addEventListener('click', (e) => {
  e.preventDefault();
  document.getElementById('sentenceType').value = 'suspended'; showBlocks();
